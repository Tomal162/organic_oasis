...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (move_uploaded_file($_FILES["productPhoto"]["tmp_name"], $targetFile)) {
        ...
        $sql = "INSERT INTO breadssweets (product_name, product_price, product_photo) VALUES (?, ?, ?)";
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-50 min-h-screen transition-all main">
        <div class="py-2 px-6 bg-lime-600 flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-30">
            ...
            <ul class="flex items-center text-sm ml-4">
                <li class="mr-2">
                    <a href="#" class="text-white hover:text-gray-600 font-medium">Categories <i class="ri-arrow-right-line"></i> Breads & Sweets</a>
                </li>
            </ul>
