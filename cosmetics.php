...
$sql_latest = "SELECT product_name, product_price, product_photo FROM cosmetics";
...
<main class="container mx-auto py-8">
    <div id="product-list" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        <?php
        // Fetch products from the database
        $query = "SELECT id, product_name, product_price, product_photo FROM cosmetics"; // Adjust table and column names as needed
